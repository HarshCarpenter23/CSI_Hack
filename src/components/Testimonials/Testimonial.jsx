...
const Testimonials =() => {
    ...
    return <Slider {...settings}>
        ...
        <div className="testimonial py-4 px-3">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, officia! Similique quas consectetur </p>
        </div>
        ...
        <div className="testimonial py-4 px-3">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, officia! Similique quas consectetur repellendus. </p>
        </div>
